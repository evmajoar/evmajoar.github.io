$(function(){($(window).width()<=768||$(window).resize())&&($(".mobile-contacts__button").click(function(){$(".mobile-contacts__modal").fadeToggle(300)}),$(window).on("scroll",function(){var o=$(this).scrollTop(),a=$(".main-header").height(),l=$(".main-header").offset().top,d=$(".mobile-contacts").height();Math.abs(l+a-d)<=o?$(".mobile-contacts").addClass("mobile-contacts--sticky"):$(".mobile-contacts").removeClass("mobile-contacts--sticky")})),$(".js-modal-form").click(function(){$(".modal").addClass("modal--slide-down").children(".modal-form").addClass("modal-form--show")}),$(".close, .overlay").click(function(){$(".modal").removeClass("modal--slide-down"),$(".modal-form").hasClass("modal-form--show")?$(".modal-form").removeClass("modal-form--show"):$(".modal-product").hasClass("modal-product--show")&&$(".modal-product").removeClass("modal-product--show")}),$(document).keyup(function(o){27===o.keyCode&&($(".modal").removeClass("modal--slide-down"),$(".modal-form").hasClass("modal-form--show")?$(".modal-form").removeClass("modal-form--show"):$(".modal-product").hasClass("modal-product--show")&&$(".modal-product").removeClass("modal-product--show"))}),$(".js-popup-product").click(function(){var o=$(this).data("id");o&&$(".modal").addClass("modal--slide-down").children(".modal-product").addClass("modal-product--show").load("products.html ."+o)}),$(".js-form").each(function(){$(this).validate({rules:{name:{required:!0,minlength:3},tel:{required:!0},email:{required:!0,email:!0}},submitHandler:function(o){$.ajax({url:"mail.php",type:"POST",data:$(o).serialize(),success:function(){window.location.href="thanks.html"}})}})}),$('input[type="tel"]').mask("8 (999) 999 99 99")});
